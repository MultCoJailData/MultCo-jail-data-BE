...
describe('booking model', () => {
  ...
  it('associates the courtCase with the correct booking', async() => {

    expect(courtCase.toObject()).toEqual({
      _id: courtCase._id,
      charges: [],
  ...
  it('can create from scrapeObject', async() => {
    ...
    const courtCasex = await CourtCase.create(scrapeObject);
    return expect(courtCasex.toObject()).toEqual({
      _id: courtCasex._id,
      charges: [],
      __v: 0
    });
